...
class _ProjectDetailsState extends State<ProjectDetails> {
    ...
    _projectSubscription = FirebaseFirestore.instance
      ...
      if (doc.exists) {
        setState(() {
          ...
          projectState = isCanceled ? "canceled" : getProjectState(data);
  ...
  String safeParseDate(String input) {
    try {
      final parsed = DateTime.parse(input);
      return parseDate(parsed); // This is your existing formatter
    } catch (e) {
      print("⚠️ Invalid date format: $input");
  ...
  Widget _buildCreativeProjectType(String type) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: Colors.blue.shade200, width: 2), // Subtle border
        boxShadow: [
          BoxShadow(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          _buildDateItem(
                            'Begins:',
                            safeParseDate(widget.startDate),
                            valueColor: Colors.green,
                          ),
                          _buildDateItem(
                            'Ends:',
                            safeParseDate(widget.deadline),
...
// ✅ After successful voting initiation, return to home screen and refresh
                                      if (result == true) {
                                        Navigator.pop(context,
                                            true); // 👈 this will trigger refresh on home page
                                      }
                                    }
                                  },
                                  style: ElevatedButton.styleFrom(
...
class DonorServices {
  ...
  static const String _contractAddress =
      '0x74409493A94E68496FA90216fc0A40BAF98CF0B9'; // Contract address on Sepolia

...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:
          AdminTermsAndConditionsPage(), // Set the Terms and Conditions page as the home screen
    );
  }
}
...
class AdminTermsAndConditionsPage extends StatefulWidget {
  @override
  _AdminTermsAndConditionsPageState createState() =>
      _AdminTermsAndConditionsPageState();
}

class _AdminTermsAndConditionsPageState
    extends State<AdminTermsAndConditionsPage> {
  ...
  void _fetchTermsAndConditions() async {
    DocumentSnapshot snapshot =
        await _firestore.collection('admin').doc('terms').get();
  }
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle:
                        TextStyle(color: Color.fromRGBO(24, 71, 137, 1)),
                      ...
                      style: OutlinedButton.styleFrom(
                        side: BorderSide(
                          color: Color.fromRGBO(
                              24, 71, 137, 1), // Border color for Save button
                          width: 3,
                        ),
                        backgroundColor:
                  ...
                  children: [
                    ...
                    OutlinedButton(
                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        backgroundColor:
                            Color.fromRGBO(212, 63, 63, 1), // Background color
                      ),
                      child: const Text(
                        '   Yes   ',
                        style: TextStyle(
    ...
    return await showDialog<bool>(
          ...
          builder: (BuildContext context) {
            ...
            return AlertDialog(
                  ...
                  children: [
                    OutlinedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        padding: EdgeInsets.symmetric(
                            horizontal: 28, vertical: 10), // Bigger button
                        shape: RoundedRectangleBorder(
                    ...
                    OutlinedButton(
                      onPressed: () {
                        ...
                        Navigator.pop(context,
                            true); // Return true after confirming addition
                      },
                      style: OutlinedButton.styleFrom(
                        side: BorderSide(
                          color: Color.fromRGBO(
              ...
              actionsPadding: const EdgeInsets.symmetric(
                  vertical: 10), // Add padding for actions
            );
          },
        ) ??
        false; // If null, default to false
                            ...
                            onChanged: (text) {
                              setState(() {
                                if (text.trimLeft().isEmpty) {
                                  _titleError =
                                      "Title cannot be empty or start with space";
                          ...
                          TextField(
                            ...
                            onChanged: (text) {
                              setState(() {
                                ...
                                if (trimmed.isEmpty) {
                                  _termError =
                                      "Term cannot be empty or only whitespace";
                                } else if (length < 10) {
                                  _termError =
                                      "Term must be at least 10 characters";
                                } else if (length > 300) {
                                  _termError =
                                      "Term cannot exceed 300 characters";
                                } else {
                                  _termError = null;
                                }
                              });
                          ...
                          ElevatedButton(
                            onPressed: isInputValid
                                ? () async {
                                    ...
                                    final term =
                                        _termsController.text.trimLeft();
